...
export const TEAM = {
  ...
  recruitment: {
    ...
    body: "We're looking for passionate people to help manage finances, shape curriculum, grow our reach, and build the future of free education. No tutoring required \u2014 just a desire to make a difference.",
    cta: "Join the Team",
    note: "Remote \u00b7 Flexible commitment",
  },
}
