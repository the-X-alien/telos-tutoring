...
export const HERO = {
  badge: "Free Peer Tutoring \u00b7 Bay Area",
  headingLine1: "Every student has a",
  headingAccent: "purpose.",
  headingLine2: "We help them find it.",
  subtitle:
    'Telos (\u03c4\u03ad\u03bb\u03bf\u03c2) \u2014 Greek for "purpose." Aristotle believed everything has a telos: the thing it\u2019s meant to become. We believe every student does too.',
...
export const STATS = {
  ...
  items: [
    { number: 50, suffix: "+", label: "Students Served" },
    { number: 20, suffix: "+", label: "Volunteer Tutors" },
    { number: 200, suffix: "+", label: "Hours of Free Tutoring" },
...
export const TEAM = {
  ...
  recruitment: {
    ...
    body: "We're always looking for dedicated high school students to join our tutor team. Earn community service hours, build leadership skills, and help younger students discover their potential. All you need is knowledge in at least one subject and the desire to help.",
    cta: "Become a Tutor",
    note: "Minimum commitment: 1 hour per week",
  },
}
...
export const FAQ_ITEMS = [
  ...
  {
    question: "Can I volunteer as a tutor?",
    answer:
      'Yes! If you\'re a high school student in the Bay Area with strong knowledge in at least one subject, we\'d love to have you. Click "Become a Tutor" to apply. You\'ll earn community service hours and real mentoring experience.',
  },
  {
...
export const CTA_SECTION = {
  ...
  tutorCard: {
    icon: "Heart",
    heading: "I Want to Tutor",
    description:
      "Join our team of volunteer peer tutors. Earn community service hours toward the MHS Community Service Ribbon, build real mentoring experience, and help younger students find their purpose.",
    cta: "Apply to Tutor",
    note: "High school students \u00b7 Bay Area",
  },
